...
public class InformationSystem {
    public static void main(String[] args) {
        ...
        // allLinks.add(new Link(workers.get(0), workers.get(2),Relation.SLAVE,
        // Relation.BOSS));
        // allLinks.add(new Link(workers.get(1), workers.get(2),Relation.SLAVE,
        // Relation.BOSS));
        // allLinks.add(new Link(workers.get(2), workers.get(3),Relation.BOSS,
        // Relation.SLAVE));
        // allLinks.add(new Link(workers.get(4), workers.get(1),Relation.BOSS,
        // Relation.SLAVE));
        // allLinks.add(new Link(workers.get(2), workers.get(3),Relation.BOSS,
        // Relation.SLAVE));
    }
